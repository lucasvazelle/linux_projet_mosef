...
def select_theme(filename):
    ...
    if "frost" in filename or "precipitation" in filename or "drought" in filename:
        return [[0, 0, 255, 128], [0, 128, 255, 128]]  # Thème bleu
    elif "fire" in filename or "heat" in filename:
        return [[255, 0, 0, 128], [255, 128, 0, 128]]  # Thème rouge
    elif "wind" in filename:
        return [[0, 128, 128, 128], [0, 255, 128, 128]]  # Thème vert/bleu
    else:
        return [[255, 0, 0, 128], [255, 128, 0, 128]]  # Thème par défaut rouge
